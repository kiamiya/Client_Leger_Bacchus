      ...
      <section>
        ...
        <article className="articles2">
          ...
          <footer className="footer">
            ...
            <form>
              <label className="quantity" htmlFor="quantity">Quantité :</label><br />
              <input className="bouton2" type="number" id="quantity" name="quantity" value={quantity} step="1" min="1" max="100" onChange={(e) => {setQuantity(Number.parseInt(e.target.value))}} /><br />
              <Link to="/" >
                <button onClick={(e) => {
                  if (basketIndex === -1) {
                    setBasket([...basket, {
